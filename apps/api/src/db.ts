...
const databasePath = resolve(process.env.SQLITE_PATH ?? './data/access.db');
...
seedChat.run(
  ...
  'Пространство «ВЕДАНИЕ. Система восстановления человека»',
  'vedanie',
  4825549,
);
seedChat.run(
  '00000000-0000-4000-8000-000000000002',
  'Пространство «ВЕДАНИЕ: гормональный возраст 35+, 45+, 55+»',
  'hormonal-age',
  4900239,
);
