...
const envSchema = z.object({
  ...
  GETCOURSE_AUDIT_SCOPE: z.enum(['off', 'test', 'all']).default('off'),
  GETCOURSE_AUDIT_INTERVAL_MINUTES: z.coerce.number().int().min(5).max(1440).default(30),
...
export const config = {
  ...
  getcourseAuditScope: parsed.GETCOURSE_AUDIT_SCOPE,
  getcourseAuditIntervalMinutes: parsed.GETCOURSE_AUDIT_INTERVAL_MINUTES,
